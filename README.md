...
![Final architecture (after iteration 5)](docs/topologi/iter-5-monitoring.png)
...
The full deployment pipeline (Packer → Terraform → cloud-init → Ansible)
is shown below:

![Deployment pipeline](docs/topologi/deployment-pipeline.png)
